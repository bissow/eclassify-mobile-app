...
import 'package:eClassify/core/utils/formatters.dart';
...
class _CreateOfferDialogContentState extends State<_CreateOfferDialogContent> {
  ...
  String _normalizeAmount(String text) {
    final normalized = widget.currency != null
        ? text.replaceAll(widget.currency!.symbol, '')
        : text;
      ...
      content: Column(
        children: [
          ...
          CustomTextField(
            ...
            formatters: [CurrencyFormatter(widget.currency, showSymbol: true)],
            validators: [
              EmptyFieldValidator(),
