...
enum ChatEventType { read, blocked, messageReceived, deleted }
...
class ChatEvent {
  ...
  factory ChatEvent.deleted({required List<int> itemOfferIds, int? itemId}) {
    return ChatEvent(
      type: ChatEventType.deleted,
      data: {'item_offer_ids': itemOfferIds, 'item_id': itemId},
    );
  }
}
