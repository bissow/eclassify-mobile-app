...
import 'package:eClassify/features/chat/screens/widgets/dialogs/delete_messages_dialog.dart';
import 'package:eClassify/features/chat/screens/widgets/item_offer_widget.dart';
    ...
    return ChatListenersScope(
      child: Scaffold(
        appBar: ChatScreenAppBar(
          ...
          onDelete: _onDelete,
          isCurrentUserSeller: widget.isSeller,
        ),
        bottomNavigationBar: _ChatBottomBar(receiver: receiver),
        body: Padding(
