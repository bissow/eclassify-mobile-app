...
import 'package:eClassify/features/chat/screens/widgets/message_composing_widgets/components/attachment_preview.dart';
...
class _RecordingContainer extends StatelessWidget {
  const _RecordingContainer({required this.child});
