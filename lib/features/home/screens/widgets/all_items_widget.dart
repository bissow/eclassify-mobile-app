...
/// measuring any of its children.
const _itemGridDelegate = SliverGridDelegateWithFixedCrossAxisCount(
  crossAxisCount: 2,
  mainAxisSpacing: 12,
  crossAxisSpacing: 12,
    ...
    for (var start = 0; start < items.length; start += interval) {
      ...
      slivers.add(
        SliverGrid(
          ...
          gridDelegate: _itemGridDelegate,
              ...
              if (state is HomeItemsSuccess) {
                ...
                return SliverMainAxisGroup(
                  slivers: _itemSlivers(
                    items: state.items,
                    showLoader: context.read<HomeItemsCubit>().hasMore,
                  ),
                );
              }
