...
class HiveStorage {
  ...
  static T? read<T>(String box, String key) =>
      Hive.box(box).get(key) as T?;
  ...
  static Future<void> addAllAsync(String box, Iterable<dynamic> values) async {
    await (await ensureOpen(box)).addAll(values);
  }
